...
<script type="text/javascript">
	   const area0 = ["지역을 선택하세요","서울특별시","인천광역시","대전광역시","광주광역시","대구광역시","울산광역시","부산광역시","경기도","강원도","충청북도","충청남도","전라북도","전라남도","경상북도","경상남도","제주도"];
...
$('document').ready(function() {
	...
	city.on('change', function() {
					...
					// 비우고
					region.empty();
					region.append('<option value="" selected>' + '동네를 선택해주세요' + '</option>');
					// 해당 시에 존재하는 구 넣기
