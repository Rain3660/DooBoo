...
<script type="text/javascript">
	...
	$(document).ready(function() {
				...
				console.log(address);// 경기도 고양시

				$('#header_title').html(address + ' 인기매물');
				...
				// 검색어 입력 후 엔터쳤을때도 검색해준다.
				$('#query').on('keypress' , function(key) {
	...
	function getProductList() {
		...
		$.ajax({
			url : 'p.selectProductListByAddressAndQuery',
			type : 'post',
...
<div class="container">
	<div class="row">
		<h2 class="text-center" id="header_title"></h2>

	</div>
	<div class="float-end">
		<div class="row">
			<div class="col">
				<input class="form-control" id="query" data-bs-toggle="tooltip" data-bs-placement="bottom" title="검색어가 제목과 내용에 포함된 상품을 검색합니다." type="search" placeholder="검색어를 입력하세요" aria-label="Search" style="width: 190px;">
			</div>
			<div class="col">
				<input class="btn btn-outline-success" type="submit" value="Search" id="search_btn">	
			</div>
		</div>
	</div>
	<div id="productList">
