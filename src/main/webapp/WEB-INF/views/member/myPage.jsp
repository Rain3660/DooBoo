        ...
        <div class="row">
        	...
        	<div class="col">
                ...
                <h3 class="mb-4">회원 프로필</h3>
                    	...
                    	<div class="row">
				            <div class="col-md-8">
					            <label for="name" class="form-label">이름</label>
							     <input type="text" class="form-control" id="name" placeholder="${loginUser.name}" required><br>
						    </div>
						    <div class="col">
						    	<div class="mb-2"></div><br>
						    	<input class="btn btn-outline-secondary" type="button" id="delete_info_btn" onclick="findAddr()" value="회원탈퇴">						   
						    </div>
						</div><br>
					    <div class="col-md-8">
			            	<label for="pw0" class="form-label">닉네임</label>
					        <input type="text" class="form-control" id="nickname" placeholder="${loginUser.nickname}" required>
					    </div><br>
					    <div>
							<p>성별</p><br>
							<h6 class="my-0">${loginUser.gender}</h6><br>
			            </div>
					    <div>
							<p>생년월일</p><br>
							<h6 class="my-0">${loginUser.birthday}</h6><br>
			            </div>
                    ...
                    <form id="updateContact" method="post">
                    	<div class="col-md-8">
			            	<label for="pw0" class="form-label">연락처</label>
					     	<input type="text" class="form-control" id="phone" placeholder="${loginUser.phone}" required>
					    </div><br>
						<div>
							<p>이메일</p><br>
							<h6 class="my-0">${loginUser.email}</h6><br>
			            </div>
			            <div class="row">
				            <div class="col-md-8">
					            <label for="address" class="form-label">주소</label>
							     <input type="text" class="form-control" id="address" placeholder="${loginUser.address }" required><br>
						    </div>
						    <div class="col">
						    	<div class="mb-2"></div><br>
						    	<input class="btn btn-outline-secondary" type="button" id="update_info_btn" onclick="findAddr()" value="주소 검색">						   
						    </div>
						</div><br>
	        ...
	        <div class="col">
				...
				<form id="updatePassword" method="post">
					<div>
						<p>아이디</p><br>
						<h6 class="my-0">${loginUser.memberId}</h6><br>
		            </div>
		            <div class="col-md-10">
		           	...
		           	<div class="col-md-10">
		           		...
		           		<span id="currPw_msg"></span>새 비밀번호</label>
		           	...
		           	<input class="btn btn-primary" type="button" id="update_pw_btn" value="수정">
				</form><br><br>
		        ...
		        <div class="col-md-10">
		            ...
		            <button type="button" class="btn btn-outline-success">나의 동네 인증상태</button><br>
